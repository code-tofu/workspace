...
public class ProductQueries {
    ...
    public static final String INSERT_NEW_PRODUCT = "INSERT INTO product_data (product_id, api_id, name_id, category,cost,details,product_name,spritesURL,sprite) VALUES  (?, ?, ?, ?, ?, ?, ?, ?, ?)";
