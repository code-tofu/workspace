// Implements a spell-checker (DOES NOT NEED TO BE MODIFIED)
...
/*
getrusage - resource.h -  Return resource usage information on process indicated by WHO and put it in *USAGE.  Returns 0 for success, -1 for failure.
